...
module.exports = {
  validateString: function (value, name) {
    assert(_.isString(value), util.format('%s should be a string', name));
  ...
  validateObject: function (value, name) {
    var isObject = _.isObject(value) && !Array.isArray(value);
  ...
  validateConnectionCounter: function (value) {
    ...
    assert(_.isNumber(value), util.format('%s should be a number', name));
